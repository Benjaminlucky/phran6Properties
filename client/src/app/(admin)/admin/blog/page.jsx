...
// ── TipTap ────────────────────────────────────────────────────────
// @tiptap/react + starter-kit + nine extensions are only needed once the post
// form modal is open, so they live in their own chunk instead of the initial
// /admin/blog bundle. ssr:false because the editor is a client-only widget.
const RichEditor = dynamic(() => import("./RichTextEditor"), {
  ssr: false,
